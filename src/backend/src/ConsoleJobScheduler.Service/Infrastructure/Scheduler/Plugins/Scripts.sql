...
-- Table: public.qrtz_settings_category

CREATE TABLE IF NOT EXISTS public.qrtz_settings_category
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    name character varying(255) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT qrtz_settings_category_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.qrtz_settings_category
    OWNER to quartz;

GRANT ALL ON TABLE public.qrtz_settings_category TO quartz;
...
(
    ...
    CONSTRAINT qrtz_settings_pkey PRIMARY KEY (id)
)
...
-- Index: QX_qrtz_settings_category_id_name

CREATE UNIQUE INDEX IF NOT EXISTS "QX_qrtz_settings_category_id_name"
    ON public.qrtz_settings USING btree
    (category_id ASC NULLS LAST, name COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;
...
(
    ...
    content bytea NOT NULL,
    create_time bigint NOT NULL,
    CONSTRAINT qrtz_packages_pkey PRIMARY KEY (id)
)
